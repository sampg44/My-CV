---
title: "Samantha Pacheco-Gomez's CV"
author: Samantha Pacheco
date: "`r Sys.Date()`"
params:
  pdf_mode:
    value: true
...
CV <- create_CV_object(
  data_location = "https://docs.google.com/spreadsheets/d/1siJPuvlY_H8l4kVZ-hL4UJrQF9iFkfmQV0OVQHD5UaA/edit?usp=sharing",  
  pdf_mode = params$pdf_mode
 )
...
Samantha Melissa Pacheco Gómez {#title}
--------------------------------------------------------------------------------
